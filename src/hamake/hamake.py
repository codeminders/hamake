...
def usage():
    print "Usage: hamake [--dry-run] [--nodeps] [-j N] [--verbose] [--test] [-f hamakefile.xml] [<target> ...]"
...
def main():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "Vvntdj:f:", ["version", "verbose", "dry-run", "test", "nodeps", "jobs","file"])
