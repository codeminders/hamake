...
maximum timestamp on all inputs (and dependency inputs[TODO: clarify
as dep. inputs are not defined yet]). Groups of files and folders
could be also organized into the \emph{sets} which could be also used
as dependencies. See hamake syntax refererence\cite{hamakesyntax} for
full syntax.
