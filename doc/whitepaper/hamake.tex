...
\textit{mapreduce} I specified location of a jar file with Hadoop job and main class name.
Next, I will add all five Hadoop Map-Reduce jobs that are left job, As you can see, these jobs takes as an input files, produced by the previous task. When you launch Hamake,
with XML descriptor from Listing~\ref{hamakeFile}, it will first loads all tasks into memory and searche for tasks that has no input or input data that does not intercept with other tasks output. This is tasks \textit{extractPlainText} -it becomes root task. As soon as Hamake has finished execution of the first task, the child task will be launched, and so on, while no tasks are left.
...
<project name="cluster books">
  ...
  <fileset id="input" path="/data/" mask="*.fb2" />
  ...
  <foreach name="extractPlainText">
    ...
    <output>
      <file id="extractPlainTextOut" path="${temporaryFolder}/extractPlainTextOut" />
    </output>
    <mapreduce jar="${lib}/hadoopJobs.job" main="com.fb2pdf.hadoop.cluster.ConvertFb2Text">
      ...
      <parameter>
        <reference idref="extractPlainTextOut" />
      </parameter>
    </mapreduce>
  </foreach>
  ...
  <foreach name="KeywordsExtractor">
    ...
    <output>
      <file id="KeywordsExtractorOut" path="${temporaryFolder}/KeywordsExtractorOut/${foreach:filename}" />
    </output>
    <mapreduce jar="${lib}/fb2pdf.job" main="com.fb2pdf.hadoop.cluster.FB2KeywordsExtractor">
      ...
      <parameter>
        <reference idref="KeywordsExtractorOut" />
      </parameter>
    </mapreduce>
  </foreach>

  <foreach name="StopwordsExcluder">
    <input>
      <fileset path="${temporaryFolder}/KeywordsExtractorOut/" />
    </input>
    <output>
      <file id="FB2StopwordsExcluderOut" path="${temporaryFolder}/KeywordsFilteredOut/${foreach:filename}" />
    </output>
    <mapreduce jar="${lib}/fb2pdf.job" main="com.fb2pdf.hadoop.cluster.FB2StopwordsExcluder">
      ...
      <parameter>
        <reference idref="StopwordsExcluderOut" />
      </parameter>
      <parameter>
        <reference idref="stopwords" />
      </parameter>
      <parameter>
        <reference idref="MetaExtractorOut"/>
      </parameter>
    </mapreduce>
  </foreach>
  ...
  <fold name="SequenceFilesFromDirectory">
    <input>
      <file id="SequenceFilesFromDirectoryIn" path="${temporaryFolder}/KeywordsFilteredOut/" />
    </input>
    <output>
      <file id="SequenceFilesFromDirectoryOut" path="${temporaryFolder}/SequenceFilesFromDirectoryOutput" />
    </output>
  ...
  <foreach name="SparseVectorsFromSequenceFiles">
    <input>
      <file id="SparseVectorsFromSequenceFilesIn" path="${temporaryFolder}/SequenceFilesFromDirectoryOutput/" />
    </input>
    <output>
      <file id="SparseVectorsFromSequenceFilesOut" path="${temporaryFolder}/SparseVectorsFromSequenceFilesOutput/" />
    </output>
    <mapreduce jar="${lib}/mahout-utils-0.3.jar" main="org.apache.mahout.text.SparseVectorsFromSequenceFiles">
      <classpath>
  ...
  <foreach name="MeanShiftCanopy">
    ...
    <output>
      <file id="MeanShiftCanopyOut" path="${temporaryFolder}/MeanShiftCanopyOutput/" />
    </output>
