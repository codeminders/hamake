...
TODO: review typesetting conventions to make sure HAMAKE is typeset uniformly
...
hamake, without need to re-process all data.
...
However hamake supports a limited scenario of interative processing,
...
iterative calculations: each run of hamake is a signle pass. This
mechanism is implemented via hamake feature called
...
Hamake is open source, disributed under Apache License v2.0. The
